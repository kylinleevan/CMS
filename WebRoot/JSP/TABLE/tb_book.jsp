	...
	<body>
		...
		function Confirm1()
		{
    		...
    		for(var i = 0; i < a.length; i++)
    		{
    			if(a[i].value == "")
        		{
        			window.location.href="./tb_book.jsp?inputbox=empty";
            		return false;
        		}
    		}
    		return true;
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-8">
					<!-- 下面是表单代码 -->
					<form class="form-horizontal" action="../../Tb_book"
						...
						<div class="form-group">
							...
							出版时间:
							<input type="text" class="form-control" id="p_date" Name="p_date" />
						</div>
						<div class="form-group">
							<label class="control-label">
							</label>
							出版单位:
							<input type="text" class="form-control" id="p_dep"
								Name="p_dep" />
						</div>
						<div class="form-group">
							<label class="control-label">
