	...
	<body>
		...
		function Confirm1()
		{
    		...
    		for(var i = 0; i < a.length; i++)
    		{
    			if(a[i].value == "")
        		{
        			window.location.href="./tb_re_poj.jsp?inputbox=empty";
            		return false;
        		}
    		}
    		return true;
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-8">
					<!-- 下面是表单代码 -->
					<form class="form-horizontal" action="../../Tb_re_poj"
						...
						<div class="form-group">
							...
							项目编号:
							<input type="text" class="form-control" id="r_serial" Name="r_serial" />
						</div>
						<div class="form-group">
							<label class="control-label">
							</label>
							项目来源:
							<input type="text" class="form-control" id="r_source"
								Name="r_source" />
						</div>
						<div class="form-group">
							<label class="control-label">
